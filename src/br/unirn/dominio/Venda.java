...
@NamedQueries({
    ...
    @NamedQuery(name = "Venda.findByIdCarrinho", query = "SELECT v FROM Venda v WHERE v.idCarrinho = :idCarrinho"),
...
public class Venda implements Serializable {
    ...
    public Venda(Integer idVenda, Date dataVenda, int idCarrinho, int quantidade, String tamanho, BigInteger valorVenda) {
        this.idVenda = idVenda;
    ...
    public String toString() {
        return "br.dominio.Venda[ idVenda=" + idVenda + " ]";
    }
